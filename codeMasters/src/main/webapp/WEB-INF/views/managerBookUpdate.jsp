        ...
        <div id="manager-status_announcement">
            ...
            <div id="book-management-contents">
                ...
                <div id="book-management-lists">
                	<form action="/project/managerBookUpdate" method="post" enctype="multipart/form-data" accept-charset="utf-8">
                		<input type="hidden" name="book_number" value="${list[0].book_number}">
                		책 이름 : <input type="text" name="book_name" value="${list[0].book_name}"> <br>
                		책 가격 : <input type="number" name="book_price" value="${list[0].book_price}"> <br>
                		책 사진 : <input type="file" name="files" multiple="multiple"> <br>
                		작가 : <input type="text" name="author" value="${list[0].author}"> <br>
                		변역가 : <input type="text" name="translator" value="${list[0].translator}"> <br>
                		출판사 : <input type="text" name="publisher" value="${list[0].publisher}"> <br>
                		등록일 : <input type="date" name="publication_date" value="${list[0].publication_date}" pattern="\d{4}-\d{2}-\d{2}" title="날짜 형식은 yyyy-mm-dd 여야 합니다."> <br>
                		책 설명 <br>
                		<textarea rows="10" cols="100" name="book_detail" >${list[0].book_detail}</textarea> <br>
