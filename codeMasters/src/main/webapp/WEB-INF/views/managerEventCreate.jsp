        ...
        <div id="manager-status_announcement">
            ...
            <div id="list-management-contents">
                ...
                <div id="list-management-event-contents">
                	<form action="/project/managerEventCreate" method="post" enctype="multipart/form-data" accept-charset="utf-8">
                		제목 : <input type="text" name="event_name"> <br>
                		이벤트 사진 : <input type="file" name="files" multiple="multiple"> <br>
                		이벤트 시작 날짜 : <input type="date" name="event_period_start" pattern="\d{4}-\d{2}-\d{2}" title="날짜 형식은 yyyy-mm-dd 여야 합니다."> <br>
                		이벤트 종료 날짜 : <input type="date" name="event_period_end" pattern="\d{4}-\d{2}-\d{2}" title="날짜 형식은 yyyy-mm-dd 여야 합니다."> <br>
                		이벤트 내용 <br>
                		<textarea rows="10" cols="100" name="event_detail"></textarea> <br>
