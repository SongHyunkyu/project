...
<body>
    <div id="top-header">
        ...
        <div id="icons">
            ...
            <%}%>
            <a href="Contact_Us_Write.jsp">
           	 	<div class="icon"><input type="button" value="문의하기" class="btn">
       			</div>
       		</a>
        </div>
        <div class="search">
            <form action="purchasingpage" method="get">
                <input type="text" name=book_name id="search_bar">
                <div id="search-icon">
                    <input type="image" src="resources/img/searchicon.png" style="width: 40px;">
                </div>
            </form>
        </div>
